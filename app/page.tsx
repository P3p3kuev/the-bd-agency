    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="px-6 py-20 md:py-32 max-w-6xl mx-auto">
        <div className="max-w-4xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <button className="px-6 py-3 bg-navy-900 text-white font-semibold hover:bg-navy-800 transition">
              Request Executive Revenue Assessment
            </button>
            <button className="px-6 py-3 border-2 border-navy-900 text-navy-900 font-semibold hover:bg-navy-50 transition">
              Explore the Enterprise Value Architecture™
            </button>
          </div>
        </div>
      </section>
      ...
      <section className="px-6 py-20 md:py-28 max-w-6xl mx-auto">
        ...
        <p className="text-gray-600 mb-12 text-sm">
          Enterprise revenue volatility manifests as four interconnected failures:
        </p>
      ...
      {/* Efficient Growth / Why Now Section */}
      <section className="px-6 py-20 md:py-28 max-w-6xl mx-auto">
      ...
      <section className="px-6 py-20 md:py-28 max-w-6xl mx-auto">
        ...
        <p className="text-gray-600 mb-12 text-sm max-w-3xl">
          We design systems that solve the structural problem. Not process. Not training. Systems.
        </p>
      ...
      <section className="px-6 py-20 md:py-28 max-w-6xl mx-auto">
        ...
        <div className="max-w-2xl mx-auto">
          <div className="border-2 border-navy-900 bg-navy-50 p-8 mb-1">
          ...
          <div className="border-2 border-navy-900 bg-navy-100 p-8 mb-1">
            <h3 className="text-lg font-semibold text-navy-900 mb-2">
              Revenue Control Indicators
            </h3>
            <p className="text-sm text-gray-700">
              Deal probability scoring, execution risk assessment, discount sensitivity modeling, stage progression validation
            </p>
          </div>

          <div className="border-2 border-navy-900 bg-navy-200 p-8">
            <h3 className="text-lg font-semibold text-navy-900 mb-2">
              Qualification Gates
            </h3>
            <p className="text-sm text-gray-700">
              Buyer fitness criteria, economic justification verification, procurement risk assessment, deal creation discipline
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="px-6 py-20 md:py-28 max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-4xl">
          <div className="border-l-4 border-navy-900 pl-6">
            <h3 className="font-semibold text-navy-900 mb-2">Buyer Fitness</h3>
            <p className="text-sm text-gray-700">
          ...
          <div className="border-l-4 border-navy-900 pl-6">
            <h3 className="font-semibold text-navy-900 mb-2">Economic Justification</h3>
            <p className="text-sm text-gray-700">
          ...
          <div className="border-l-4 border-navy-900 pl-6">
            <h3 className="font-semibold text-navy-900 mb-2">Procurement Reality</h3>
            <p className="text-sm text-gray-700">
          ...
          <div className="border-l-4 border-navy-900 pl-6">
            <h3 className="font-semibold text-navy-900 mb-2">Execution Capability</h3>
            <p className="text-sm text-gray-700">
      ...
      <section className="px-6 py-20 md:py-28 max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-4xl">
          ...
          <div className="border-l-4 border-navy-900 pl-6">
            <h3 className="font-semibold text-navy-900 mb-2">Discount Sensitivity</h3>
            <p className="text-sm text-gray-700">
          ...
          <div className="border-l-4 border-navy-900 pl-6">
            <h3 className="font-semibold text-navy-900 mb-2">Execution Risk</h3>
            <p className="text-sm text-gray-700">
          ...
          <div className="border-l-4 border-navy-900 pl-6">
            <h3 className="font-semibold text-navy-900 mb-2">Stage Progression Validity</h3>
            <p className="text-sm text-gray-700">
      ...
      <section className="px-6 py-20 md:py-28 max-w-6xl mx-auto">
        <div className="max-w-3xl">
          ...
          <button className="px-8 py-4 bg-navy-900 text-white font-semibold hover:bg-navy-800 transition text-lg">
            Request Executive Revenue Assessment
          </button>
        </div>
      </section>
